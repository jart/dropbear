...
func TestWWMA_MatchesQuantConnect(t *testing.T) {
	...
	assertEq(t, "step 4", w.Value, decimal.Parse("11.666666"))

	w.Add(decimal.FromInt(14))
	// 14/3 + (35/3)*2/3 = 14/3 + 70/9 = 42/9 + 70/9 = 112/9 = 12.444...
	assertEq(t, "step 5", w.Value, decimal.Parse("12.444443"))
}
...
func TestWWMA_Period14(t *testing.T) {
	...
	assertEq(t, "after warmup", w.Value, decimal.Parse("8.035717"))
}
