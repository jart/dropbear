...
type CryptoTransfer struct {
	...
	Amount      string `json:"amount"`       // e.g. 0.02200293
	USDValue    string `json:"usd_value"`    // e.g. 1996.944374747
	...
	CreatedAt   string `json:"created_at"`   // e.g. 2025-11-28T19:07:17.66569Z
	NetworkFee  string `json:"network_fee"`  // e.g. 0.0001
	Fees        string `json:"fees"`         // e.g. 0.0001
}
