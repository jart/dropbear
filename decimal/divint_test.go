...
func TestDivInt(t *testing.T) {
	tests := []struct {
		...
		// repeating decimals
		{"1 / 3 = 0.333333333", One, 3, Parse("0.333333333")},
		{"2 / 3 = 0.666666667", Two, 3, Parse("0.666666667")},
		{"1 / 6 = 0.166666667", One, 6, Parse("0.166666667")},
		{"1 / 7 = 0.142857143", One, 7, Parse("0.142857143")},
		{"1 / 9 = 0.111111111", One, 9, Parse("0.111111111")},
		...
		{"1 / 100000000 = 0.00000001", One, 100000000, Parse("0.00000001")},
