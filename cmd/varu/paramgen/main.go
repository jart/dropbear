...
// Usage:
//
//	go run ./cmd/varu/paramgen -o cmd/varu/params.go
...
// simulate runs the varu algorithm and returns (sharpe, total_return)
...
func writeOutput(results []Result) error {
	...
	buf.WriteString("// Code generated by go run ./cmd/varu/paramgen -o cmd/varu/params.go. DO NOT EDIT.\n\n")
