// study replays recorded sip data to evaluate the quote imbalance
// trading strategy. it measures signal predictive power at various
// time horizons and compares maker vs taker economics.
//
