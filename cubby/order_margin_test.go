...
func TestOpenLimitOrder_ReservesMargin(t *testing.T) {
	...
	ex.IsDayTradingTime = true // Enable 4x day trading mode
	ex.Lock.Unlock()
	...
	netBP := ex.GetNetAvailableBuyingPower()
...
func TestMultipleOrders_CumulativeMargin(t *testing.T) {
	...
	ex.DayTradingBuyingPower.Store(decimal.FromInt(400000))
	ex.Lock.Unlock()
...
func TestClosingOrder_NoMarginReserved(t *testing.T) {
	...
	ex.DayTradingBuyingPower.Store(decimal.FromInt(160000))
	ex.Lock.Unlock()
